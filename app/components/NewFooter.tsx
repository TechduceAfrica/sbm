...
const NewFooter = () => {
  ...
  return (
    <div className=" mt-[50px] relative w-full h-full bg-footer-blue flex  text-white text-[22px] lg:text-[32px] px-[40px] py-[80px] ">
      <div className="justify-between flex flex-col lg:flex-row gap-10 mb-12">
        {/* Logo */}
        <div className="logo">
          <Link
            href="/"
        ...
        <div className="content flex flex-col lg:flex-row gap-6 text-[18px]">
          ...
          <div className="flex flex-col lg:flex-row gap-2  w-[30px]  h-[30px]">
            <img src="/facebookLogo.svg" alt="" />
            <img src="ig-icon.svg" alt="" />
          </div>
        </div>
      </div>
      <div className="absolute bottom-[20px] lg:left-[152px] left-3 lg:text-[13px] text-[10px]  font-primary">
